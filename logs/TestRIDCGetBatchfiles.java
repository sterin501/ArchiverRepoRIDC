...
public class TestRIDCGetBatchfiles {
	...
	public static void main(String[] args) {
		...
		try{
           ...
           // dataBinder.putLocal("aBatchFile","13-oct-04_11.44.43_577_03/13277114443~1.hda");
     ...
     //       serializer.serializeBinder (System.out, responseData);
            ...
            for (DataObject dataObject : resultSet.getRows ()) {
                System.out.println ("Batch Name is: " + dataObject.get ("aBatchFile"));
